...
- ` + "`1-ff00:0:133#0 1-ff00:0:120#2,1 0 0 1-ff00:0:110#0`:" + ` Path from any interface in AS 1-ff00:0:133
  to two subsequent interfaces in AS 1-ff00:0:120 (entering on interface 2 and exiting on interface 1),
  then two wildcards, ending with any interface in AS 1-ff00:0:110.
- ` + "`1-ff00:0:133#1 1+ 2-ff00:0:1? 2-ff00:0:233#1`:" + ` Path from interface 1-ff00:0:133#1
  through multiple ASes in ISD 1, may traverse AS 2-ff00:0:1, then reaches 2-ff00:0:233#1.
